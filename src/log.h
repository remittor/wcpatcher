...
#define LOGX_IF(_level_, _cond_, ...)   if ((_cond_)) WcpPrintMsgA(_level_, __VA_ARGS__)
#define LOGX(_level_, ...)              WcpPrintMsgA(_level_, __VA_ARGS__)

#define WLOGX_IF(_level_, _cond_, ...)  if ((_cond_)) WcpPrintMsgW(_level_, __VA_ARGS__)
#define WLOGX(_level_, ...)             WcpPrintMsgW(_level_, __VA_ARGS__)
